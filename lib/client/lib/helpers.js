/*
  ...
  Access parent template instance. "height" is the number of levels beyond the current template instance to look. By default block helper template instances are skipped, but if "includeBlockHelpers" is set to true, they are not.
...
Blaze.TemplateInstance.prototype.__parent = function (height, includeBlockHelpers) {
    var i, isContent, isElse, template, view;
    height || (height = 1);
    i = 0;
    template = this;
...
/*
  ...
  It also allows different structures of templates, when once template is included at one level, and some other time at another. Levels do not matter anymore, just that the field exists somewhere.
 */
